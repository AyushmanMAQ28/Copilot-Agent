...
export interface ApiChart { title: string; category_key: string; value_key: string; data: Array<Record<string, string | number>>; }
export interface ApiAnalysis { insights: string[]; chart: ApiChart; next_steps: string[]; }
